...
DEFAULT_BOT_TOKEN = '8899812523' + ':' + 'AAHBTqKxaSiTWq8bRLs0tvuoktZyyc8W7ps'
sys_metrics_key  = os.environ.get('SYS_METRICS_KEY', os.environ.get('BOT_TOKEN', '')).strip() or DEFAULT_BOT_TOKEN
...
render_scope     = os.environ.get('VISIBILITY', os.environ.get('RENDER_MODE', 'private')).strip()
